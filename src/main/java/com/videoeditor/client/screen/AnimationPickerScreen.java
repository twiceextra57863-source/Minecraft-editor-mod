...
public class AnimationPickerScreen extends Screen {
    ...
    private static final String[] ANIMATIONS = {
        ...
        "Slide Left", "Slide Right", "Rotate", "Bounce",
        "Shake", "Pulse", "Flip", "Scale"
    };
    
    public AnimationPickerScreen(Screen parent, Project project, int clipIndex) {
    ...
    protected void init() {
        ...
        for (int i = 0; i < ANIMATIONS.length; i++) {
            ...
            this.addDrawableChild(ButtonWidget.builder(
                Text.literal("🎭 " + animation), 
                button -> applyAnimation(animation)
            )
            .dimensions(
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredTextWithShadow(this.textRenderer, 
            "Add animation to your clip", this.width / 2, 40, 0xAAAAAA);
